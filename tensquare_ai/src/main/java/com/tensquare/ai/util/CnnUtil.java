...
public class CnnUtil {
    ...
    public static ComputationGraph createComputationGraph(int cnnLayerFeatureMaps) {
        ...
        ComputationGraphConfiguration config = new NeuralNetConfiguration.Builder()
                ...
                .addLayer("globalPool", new GlobalPoolingLayer.Builder().build(), "merge") //池化层
     ...
     * @return
     */
    public static DataSetIterator getDataSetIterator(String path, String[] childPaths, WordVectors wordVectors, int minibatchSize, int maxSentenceLength, Random random) {
